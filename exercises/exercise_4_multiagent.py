...
def check_routing(state: State) -> list[Send]:
    ...
    if any(kw in question_lower for kw in ["data", "privacy", "gdpr", "dữ liệu", "rò rỉ", "bảo mật dữ liệu"]):
...
Hãy phân tích các vấn đề về quyền riêng tư, rò rỉ dữ liệu, GDPR, CCPA, data breach notification.
...
def build_graph() -> StateGraph:
    ...
    # Add nodes (check_routing là routing function, không phải node)
    ...
    # check_routing trả về list[Send] nên dùng trực tiếp trong conditional_edges
